...
export const questionsData = [
    {
        ...
        questions: [
            ...
            { text: "Какой интерфейс используется для передачи цифровых аудиосигналов через оптоволокно?", answer: "SPDIF 'тюльпан'", points: 400 },
            { text: "Какие цвета 'тюльпанов' используются для компонентного выхода HDTV?",answer: "Жёлтый, белый и красный", points: 500 },
            { text: "Какой цвет разъема PS/2 обычно используется для подключения клавиатуры?", answer: "Сиреневый/Фиолетовый ", points: 600 },
            { text: "Как называется устройство, преобразующее аналоговый видеосигнал с ТВ-антенны или кабельного телевидения в цифровой формат, пригодный для воспроизведения на компьютере?", answer: "TV-тюнер", points: 700 },
            { text: "Какой интерфейс, используемый в профессиональной сфере, позволяет передавать данные между компьютером и аудиоустройствами с высокой пропускной способностью, был разработан компанией Apple?", answer: "Thunderbolt или FireWire", points: 800 }
        ]
    },
    {
        ...
        questions: [
            ...
            { text: "Как называется устройство преобразующее электроэнергию для ПК", answer: "Блок питания", points: 200 },
            { text: "Элемент, управляющий выводом графической информации, может быть встроенным или отдельным", answer: "Видеоконтроллер", points: 300 },
            { text: "Какой компонент компьютера хранит данные и инструкции, необходимые для текущих вычислений, но теряет их при выключении питания?", answer: "Оперативная память, RAM", points: 400 },
            { text: "Интерфейс для передачи данных несколькими битами одновременно -  ", answer: "Параллельный порт", points: 500 },
            { text: "Как называется шина, соединяющая процессор, оперативную память и другие устройства? ", answer: "Системная шина", points: 600 },
            { text: "Как называется высокоскоростная память, используемая процессором для временного хранения часто используемых данных, которая делится на уровни L1, L2 и L3?", answer: "Кеш-память процессора", points: 700 },
            { text: "Как называется микросхема или набор микросхем, который управляет работой материнской платы и взаимодействием её компонентов?  ", answer: "Чипсет", points: 800 }
        ]
    },
    {
