...
export const questionsData = [
    {
        ...
        questions: [
            { text: "Как называется стандартный интерфейс для подключения флеш-накопителей, внешних жёстких дисков и других периферийных устройств, впервые представленный в 1996 году? ", img:null, answer: "USB", points: 10 },
    ...
    },
    {
        ...
        questions: [
            { text: "Как называется основной вычислительный элемент компьютера? ", img:null, answer: "Процессор, CPU", points: 10 },
            ...
            { text: "Элемент, управляющий выводом графической информации, может быть встроенным или отдельным", img:null, answer: "Видеоконтроллер", points: 40 },
            ...
            { text: "Интерфейс для передачи данных несколькими битами одновременно -  ", answer: "Параллельный порт",img:null,  points: 60 },
    ...
    },
    {
        ...
        questions: [
            ...
            { text: "Какой британский математик и логик в 1830-х годах разработал концепцию аналитической машины, предвосхитившую ЭВМ?",img:null,  answer: "Чарльз Бэббидж", points: 30 },
            ...
            { text: "Какой компьютер стал первым в истории ноутбуком? ", img:null, answer: "Osborne 1", points: 50 },
            ...
            { text: "Как называлась советская серия компьютеров, созданная как аналог IBM PC? ", img:null, answer: "ЕС ЭВМ — Единая Система ЭВМ", points: 80 },
    ...
    },
    {
        ...
        questions: [
            ...
            { text: "Как называется самая распространённая операционная система для персональных компьютеров, разработанная компанией Microsoft?",img:null,  answer: "Windows", points: 20 },
    ...
    },
    {
        ...
        questions: [
            ...
            { text: "В чём заключается принцип работы квантовых вычислений по сравнению с классическими?", img:null, answer: "Использование кубитов, суперпозиции и квантового запутывания", points: 90 },
            { text: "Какой алгоритм применяется для обхода графа в глубину?", img:null, answer: "Поиск в глубину (DFS, Depth-First Search)", points: 100 }
        ]
    }
];
