...
export const questionsData = [
    {
        ...
        questions: [
            { text: "Как называется стандартный интерфейс для подключения флеш-накопителей, внешних жёстких дисков и других периферийных устройств, впервые представленный в 1996 году? ",page:"", answer: "USB", points: 100 },
